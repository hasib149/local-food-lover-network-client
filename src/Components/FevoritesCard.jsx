    ...
    place-items-center w-11/12 mx-auto"
      >
        {reviews.map((review) => (
          <div
            key={review._id}
            className="max-w-sm bg-white rounded-xl shadow-lg overflow-hidden transform transition-all duration-500 hover:scale-105 hover:shadow-xl flex flex-col h-full"
          >
            <img
